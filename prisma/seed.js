...
const enemies = [
  {
    ...
    tags: ["forest", "minion"],
    abilities: [
      { abilitySlug: "slash", priority: 0, weight: 3 },
      { abilitySlug: "bleeding_edge", priority: 1, weight: 2 },
    ],
  },
  {
    slug: "ember-sprite",
    ...
    tags: ["elemental", "fire"],
    abilities: [
      { abilitySlug: "firebolt", priority: 0, weight: 3 },
      { abilitySlug: "flame_wave", priority: 1, weight: 2 },
    ],
  },
  {
    slug: "grave-wight",
    name: "Grave Wight",
    description: "An undead spellblade that chills the soul and binds the living.",
    level: 5,
    baseStats: {
      health: 120,
      attack: 18,
    ...
    tags: ["undead", "elite"],
    abilities: [
      { abilitySlug: "grave_chill", priority: 0, weight: 2 },
      { abilitySlug: "life_drain", priority: 1, weight: 1 },
      { abilitySlug: "entangling_roots", priority: 2, weight: 1 },
    ],
  },
  {
    slug: "storm-wyvern",
    name: "Storm Wyvern",
    description: "A winged terror that rides the heart of the tempest.",
    level: 6,
    baseStats: {
      health: 150,
      attack: 16,
    ...
    tags: ["beast", "flying", "elite"],
    abilities: [
      { abilitySlug: "chain_lightning", priority: 0, weight: 2 },
      { abilitySlug: "thunderclap", priority: 1, weight: 1 },
      { abilitySlug: "tempest", priority: 2, weight: 1 },
    ],
  },
  {
    slug: "obsidian-golem",
    ...
    tags: ["construct", "tank"],
    abilities: [
      { abilitySlug: "earth_shatter", priority: 0, weight: 2 },
      { abilitySlug: "crystalline_spines", priority: 1, weight: 1 },
      { abilitySlug: "stone_skin", priority: 2, weight: 1 },
    ],
  },
  {
    slug: "void-scholar",
    ...
    tags: ["void", "caster", "elite"],
    abilities: [
      { abilitySlug: "void_rift", priority: 0, weight: 2 },
      { abilitySlug: "mana_burn", priority: 1, weight: 1 },
      { abilitySlug: "arcane_barrier", priority: 2, weight: 1 },
    ],
  },
  {
    slug: "ashen-phoenix",
    ...
    tags: ["beast", "fire", "boss"],
    abilities: [
      { abilitySlug: "meteor_swarm", priority: 0, weight: 2 },
      { abilitySlug: "flame_wave", priority: 1, weight: 1 },
      { abilitySlug: "phoenix_rebirth", priority: 2, weight: 1 },
    ],
  },
];
