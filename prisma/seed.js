...
const abilities = [
  ...
  },
  {
    slug: "meteor_swarm",
    name: "Meteor Swarm",
    description: "Call down a barrage of meteors that ignite the battlefield.",
    school: "FIRE",
    target: "AREA",
    basePower: 28,
    resourceCost: 8,
  ...
  },
  {
    slug: "void_rift",
    name: "Void Rift",
    description: "Tear open a rift that saps will and freezes time.",
    school: "SHADOW",
    target: "AREA",
    basePower: 16,
    resourceCost: 6,
  ...
  },
  {
    slug: "grave_chill",
    name: "Grave Chill",
    description: "Drain warmth from a foe, slowing their every motion.",
    school: "SHADOW",
    target: "ENEMY",
    basePower: 14,
    resourceCost: 4,
  ...
  {
    slug: "crystalline_spines",
    name: "Crystalline Spines",
    description: "Raise a jagged carapace that shrugs off assaults.",
    school: "EARTH",
    target: "SELF",
    basePower: 0,
    resourceCost: 0,
    cooldownTurns: 4,
    speedModifier: -1,
    tags: ["earth", "defense", "elite"],
    formula: {
      type: "buff",
      effect: {
        name: "crystalline_spines",
        duration: 3,
        statMultipliers: { defense: 1.25 },
  ...
  {
    slug: "phoenix_rebirth",
    name: "Phoenix Rebirth",
    description: "Envelop allies in renewing flame that refuses to die.",
    school: "FIRE",
    target: "SELF",
    basePower: 0,
    resourceCost: 0,
...
const enemies = [
  {
    slug: "forest-goblin",
    name: "Forest Goblin",
    description: "A mischievous creature that ambushes travelers along woodland paths.",
    level: 2,
    baseStats: {
      health: 60,
      attack: 12,
  ...
  },
  {
    slug: "spriggan-scout",
    name: "Spriggan Scout",
    description: "A nimble guardian of the deep forest wielding poisonous spores.",
    level: 4,
    baseStats: {
      health: 110,
      attack: 14,
    ...
    abilities: [
      ...
      {
        abilitySlug: "entangling_roots",
        priority: 1,
        weight: 1,
      },
      {
        abilitySlug: "wild_growth",
        priority: 2,
        weight: 1,
      },
    ],
  },
  {
    slug: "ancient-treant",
    name: "Ancient Treant",
    description: "An ancient tree-spirit that shields the wilds with living bark.",
    level: 7,
    baseStats: {
      health: 220,
      attack: 18,
  ...
  },
  {
    slug: "plains-lurker",
    name: "Plains Lurker",
    description: "A swift predator that darts through tall grass before striking.",
    level: 3,
    baseStats: {
      health: 80,
      attack: 15,
    ...
    abilities: [
      {
        abilitySlug: "twin_fangs",
        priority: 0,
        weight: 2,
      },
      {
        abilitySlug: "shadow_step",
        priority: 1,
        weight: 1,
      },
    ],
  },
  {
    slug: "sunblade-nomad",
    name: "Sunblade Nomad",
    description: "A seasoned warrior of the sunlit plains, fearless in mounted combat.",
    level: 5,
    baseStats: {
      health: 140,
      attack: 20,
  ...
  },
  {
    slug: "storm-lancer",
    name: "Storm Lancer",
    description: "An elite cavalier who commands thunder and lance alike.",
    level: 8,
    baseStats: {
      health: 200,
      attack: 22,
  ...
  },
  {
    slug: "stone-ram",
    name: "Stone Ram",
    description: "A mountain beast with horns hardened by granite cliffs.",
    level: 3,
    baseStats: {
      health: 90,
      attack: 14,
  ...
  },
  {
    slug: "sky-roc",
    name: "Sky Roc",
    description: "A colossal bird of prey that commands the alpine winds.",
    level: 6,
    baseStats: {
      health: 150,
      attack: 19,
    ...
    abilities: [
      ...
      {
        abilitySlug: "whirlwind",
        priority: 1,
        weight: 1,
      },
      {
        abilitySlug: "thunderclap",
        priority: 2,
        weight: 1,
      },
    ],
  },
  {
    slug: "obsidian-golem",
    name: "Obsidian Golem",
    description: "An ancient construct that shrugs off blows with crystalline hide.",
    level: 7,
    baseStats: {
      health: 220,
      attack: 14,
    ...
    tags: ["mountain", "high", "construct"],
    abilities: [
      {
        abilitySlug: "earth_shatter",
        priority: 0,
        weight: 2,
      },
      {
        abilitySlug: "crystalline_spines",
        priority: 1,
        weight: 1,
      },
      {
  ...
  {
    slug: "tidebreaker-crab",
    name: "Tidebreaker Crab",
    description: "A hulking crustacean that batters intruders along the coast.",
    level: 3,
    baseStats: {
      health: 95,
      attack: 13,
  ...
  },
  {
    slug: "coral-siren",
    name: "Coral Siren",
    description: "A singing spirit that lures sailors with healing tides and venomous song.",
    level: 5,
    baseStats: {
      health: 120,
      attack: 10,
  ...
  },
  {
    slug: "storm-corsair",
    name: "Storm Corsair",
    description: "A pirate champion who duels with lightning-charged blades.",
    level: 7,
    baseStats: {
      health: 170,
      attack: 22,
  ...
  },
  {
    slug: "frost-wolf",
    name: "Frost Wolf",
    description: "A tundra predator whose breath freezes armor solid.",
    level: 4,
    baseStats: {
      health: 100,
      attack: 16,
  ...
  },
  {
    slug: "glacier-giant",
    name: "Glacier Giant",
    description: "A towering being of ice whose steps fracture the permafrost.",
    level: 8,
    baseStats: {
      health: 240,
      attack: 20,
    ...
    tags: ["tundra", "high", "elite"],
    abilities: [
      {
        abilitySlug: "hailstorm",
        priority: 0,
        weight: 2,
      },
      {
  ...
  },
  {
    slug: "aurora-wraith",
    name: "Aurora Wraith",
    description: "A spectral remnant of the north that bends light and time.",
    level: 9,
    baseStats: {
      health: 180,
      attack: 12,
    ...
    tags: ["tundra", "boss", "spirit"],
    abilities: [
      {
        abilitySlug: "void_rift",
        priority: 0,
        weight: 2,
      },
      {
  ...
  {
    slug: "lava-salamander",
    name: "Lava Salamander",
    description: "A molten amphibian that leaves pools of burning magma in its wake.",
    level: 5,
    baseStats: {
      health: 130,
      attack: 16,
  ...
  },
  {
    slug: "ashen-phoenix",
    name: "Ashen Phoenix",
    description: "A legendary phoenix that immolates battlefields and rises anew.",
    level: 9,
    baseStats: {
      health: 160,
      attack: 18,
    ...
    tags: ["volcanic", "boss", "beast"],
    abilities: [
      {
        abilitySlug: "meteor_swarm",
        priority: 0,
        weight: 2,
      },
      {
  ...
  },
  {
    slug: "magma-behemoth",
    name: "Magma Behemoth",
    description: "A titanic brute of molten rock that shatters the caldera floor.",
    level: 10,
    baseStats: {
      health: 320,
      attack: 24,
  ...
  },
  {
    slug: "void-scholar",
    name: "Void Scholar",
    description: "A mage who learned too much from the abyss.",
    level: 8,
    baseStats: {
      health: 140,
      attack: 10,
    ...
    abilities: [
      ...
      {
        abilitySlug: "mana_burn",
        priority: 1,
        weight: 1,
      },
      {
        abilitySlug: "arcane_barrier",
        priority: 2,
        weight: 1,
      },
    ],
  },
  {
    slug: "astral-paragon",
    name: "Astral Paragon",
    description: "A champion of the Celestial Plane wielding starlight and judgment.",
    level: 11,
    baseStats: {
      health: 260,
      attack: 22,
    ...
    tags: ["celestial", "apex", "boss"],
    abilities: [
      {
        abilitySlug: "starfall",
        priority: 0,
        weight: 2,
      },
      {
